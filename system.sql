...
CREATE USER C##P_pro_orederpass IDENTIFIED BY 12345
DEFAULT TABLESPACE USERS
TEMPORARY TABLESPACE TEMP
QUOTA 10M ON USERS;

GRANT CREATE SESSION TO C##P_pro_orederpass;

GRANT CREATE SESSION, CREATE TABLE TO C##P_pro_orederpass;

GRANT CONNECT, RESOURCE TO C##P_pro_orederpass;
